...
<body id="page-top">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="/sbadmin/startbootstrap-sb-admin-2-gh-pages/img/undraw_profile.svg">
                            </a>
    ...
    <!-- Page level plugins -->
    <script src="/sbadmin/startbootstrap-sb-admin-2-gh-pages/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="/sbadmin/startbootstrap-sb-admin-2-gh-pages/js/demo/chart-area-demo.js"></script>
    <script src="/sbadmin/startbootstrap-sb-admin-2-gh-pages/js/demo/chart-pie-demo.js"></script>
